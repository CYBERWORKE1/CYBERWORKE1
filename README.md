...
analyst = {
    ...
    "education" : "B.E. Computer Science @ Chandigarh University (2026)",
    "focus"     : ["EDA", "Dashboard Design", "KPI Reporting", "SQL Analytics"],
    "currently" : "Building data projects & seeking analyst roles",
...
> Interactive dashboard with **7 custom DAX measures** analyzing sales across time, category & customer segments.
- Electronics → ~40% of total revenue
...
- Feature engineering, missing value treatment, statistical analysis
- Multi-dimensional Seaborn/Matplotlib visualizations
